...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'course.elderly': 'دورة رعاية المسنين',
    'course.elderly.desc': 'العناية الخاصة بكبار السن',
    'course.nurseassistant': 'دورة مساعد ممرض',
    'course.nurseassistant.desc': 'المساعدة في الرعاية التمريضية',
    'course.dentalassistant': 'دورة مساعد طبيب أسنان',
    'course.dentalassistant.desc': 'المساعدة في عيادات طب الأسنان',
    'course.medicalassistant': 'دورة مساعد طبي',
    'course.medicalassistant.desc': 'المساعدة في العيادات والمستشفيات',
    'course.pharmacist': 'دورة بائع صيدلي',
    'course.pharmacist.desc': 'بيع الأدوية وخدمة العملاء في الصيدليات',
    'course.nutritionist': 'دورة أخصائي التغذية',
    'course.nutritionist.desc': 'تعلم أساسيات التغذية الصحية والعلاجية',
    
    // Pricing
    'pricing.title': 'أسعارنا',
    'pricing.single': 'شهادة واحدة',
    'pricing.double': 'شهادتين',
    'pricing.triple': '3 شهادات',
    ...
    'pricing.triple.features': '3 شهادات معتمدة + 4 شهادات مجانية + توصيل مجاني',
    ...
    'form.card.title': 'معلومات البطاقة',
    'form.card.number': 'رقم البطاقة',
    'form.card.expiry': 'تاريخ الانتهاء (MM/YY)',
    'form.card.cvv': 'CVV / CVC2',
    'form.card.error': 'خطأ في معلومات البطاقة',
    'form.card.numberRequired': 'الرجاء إدخال رقم البطاقة صحيح',
    'form.card.expiryRequired': 'الرجاء إدخال تاريخ الانتهاء (MM/YY)',
    'form.card.cvvRequired': 'الرجاء إدخال رمز CVV صحيح',
  ...
  fr: {
    ...
    'courses.certificate': 'Certificat de stage accrédité',
    'courses.internship': 'Certificat de stage valable de 1 à 6 mois',
    
    // Course Names
    'course.firstaid': 'Cours de Premiers Secours',
    'course.firstaid.desc': 'Apprenez les techniques de premiers secours et de sauvetage',
    'course.laboratory': 'Cours d\'Assistant Laboratoire',
    'course.laboratory.desc': 'Analyse des échantillons médicaux et tests de laboratoire',
    'course.ambulance': 'Cours de Conducteur Ambulancier',
    'course.ambulance.desc': 'Conduite ambulance et intervention rapide',
    'course.dentalrestorer': 'Cours d\'Assistant Restauration Dentaire',
    'course.dentalrestorer.desc': 'Assistance en restauration et esthétique dentaire',
    'course.medicalsecretary': 'Cours de Secrétariat Médical',
    'course.medicalsecretary.desc': 'Gestion des dossiers médicaux et rendez-vous',
    'course.elderly': 'Cours de Soins aux Personnes Âgées',
    'course.elderly.desc': 'Soins spécialisés pour les seniors',
    'course.nurseassistant': 'Cours d\'Aide-Soignant',
    'course.nurseassistant.desc': 'Assistance aux soins infirmiers',
    'course.dentalassistant': 'Cours d\'Assistant Dentaire',
    'course.dentalassistant.desc': 'Assistance dans les cabinets dentaires',
    'course.medicalassistant': 'Cours d\'Assistant Médical',
    'course.medicalassistant.desc': 'Assistance dans les cliniques et hôpitaux',
    'course.pharmacist': 'Cours de Vendeur en Pharmacie',
    'course.pharmacist.desc': 'Vente de médicaments et service client en pharmacie',
    'course.nutritionist': 'Cours de Nutritionniste',
    'course.nutritionist.desc': 'Apprenez les bases de la nutrition saine et thérapeutique',
    
    // Pricing
    'pricing.title': 'Nos Tarifs',
    'pricing.single': 'Un Certificat',
    'pricing.double': 'Deux Certificats',
    'pricing.triple': '3 Certificats',
    'pricing.single.price': '4,900 DZD',
    'pricing.double.price': '9,800 DZD',
    'pricing.triple.price': '14,700 DZD',
    'pricing.single.features': 'Un certificat accrédité',
    'pricing.double.features': '2 certificats + certificat gratuit de 4,900 DZD',
    'pricing.triple.features': '3 certificats accrédités + 4 certificats gratuits + Livraison gratuite',
    ...
    'form.card.title': 'Informations de la carte',
    'form.card.number': 'Numéro de carte',
    'form.card.expiry': 'Date d\'expiration (MM/AA)',
    'form.card.cvv': 'CVV / CVC2',
    'form.card.error': 'Erreur dans les informations de la carte',
    'form.card.numberRequired': 'Veuillez entrer un numéro de carte valide',
    'form.card.expiryRequired': 'Veuillez entrer la date d\'expiration (MM/AA)',
    'form.card.cvvRequired': 'Veuillez entrer un code CVV valide',
  ...
  en: {
    ...
    'courses.certificate': 'Accredited Internship Certificate',
    'courses.internship': 'Internship certificate valid from 1 to 6 months',
    
    // Course Names
    'course.firstaid': 'First Aid Course',
    'course.firstaid.desc': 'Learn first aid techniques and life-saving skills',
    'course.laboratory': 'Laboratory Assistant Course',
    'course.laboratory.desc': 'Medical sample analysis and laboratory testing',
    'course.ambulance': 'Ambulance Driver Course',
    'course.ambulance.desc': 'Ambulance driving and rapid intervention',
    'course.dentalrestorer': 'Dental Restorer Assistant Course',
    'course.dentalrestorer.desc': 'Assistance in dental restoration and aesthetics',
    'course.medicalsecretary': 'Medical Secretary Course',
    'course.medicalsecretary.desc': 'Medical records and appointment management',
    'course.elderly': 'Elderly Care Course',
    'course.elderly.desc': 'Specialized care for seniors',
    'course.nurseassistant': 'Nurse Assistant Course',
    'course.nurseassistant.desc': 'Assistance in nursing care',
    'course.dentalassistant': 'Dental Assistant Course',
    'course.dentalassistant.desc': 'Assistance in dental clinics',
    'course.medicalassistant': 'Medical Assistant Course',
    'course.medicalassistant.desc': 'Assistance in clinics and hospitals',
    'course.pharmacist': 'Pharmacist Salesman Course',
    'course.pharmacist.desc': 'Medication sales and pharmacy customer service',
    'course.nutritionist': 'Nutritionist Course',
    'course.nutritionist.desc': 'Learn the basics of healthy and therapeutic nutrition',
    
    // Pricing
    'pricing.title': 'Our Pricing',
    'pricing.single': 'One Certificate',
    'pricing.double': 'Two Certificates',
    'pricing.triple': '3 Certificates',
    'pricing.single.price': '4,900 DZD',
    'pricing.double.price': '9,800 DZD',
    'pricing.triple.price': '14,700 DZD',
    'pricing.single.features': 'One accredited certificate',
    'pricing.double.features': '2 certificates + free certificate worth 4,900 DZD',
    'pricing.triple.features': '3 accredited certificates + 4 free certificates + Free delivery',
    ...
    'form.card.title': 'Card Information',
    'form.card.number': 'Card Number',
    'form.card.expiry': 'Expiry Date (MM/YY)',
    'form.card.cvv': 'CVV / CVC2',
    'form.card.error': 'Card information error',
    'form.card.numberRequired': 'Please enter a valid card number',
    'form.card.expiryRequired': 'Please enter expiry date (MM/YY)',
    'form.card.cvvRequired': 'Please enter a valid CVV code',
