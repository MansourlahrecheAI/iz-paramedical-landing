...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'pricing.triple.features': '3 شهادات معتمدة + 4 شهادات مجانية',
  ...
  fr: {
    ...
    'pricing.triple.features': '3 certificats accrédités + 4 certificats gratuits',
  ...
  en: {
    ...
    'pricing.triple.features': '3 accredited certificates + 4 free certificates',
